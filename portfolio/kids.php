  ...
  <head>
    ...
    <style>
      ...
      .col-md-4 {
        ...
        background-image: url("../images/covers/IMG_1063.jpg");
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <h1>Kids Photo Sessions</h1>

        <br />

        <h3>

        The eyelashes, the cute nose freckles, that curly hair, and oh so adorable giggle. As I’m sure you know, kids grow up, and they grow up fast. They are forever changing, it is priceless to be able to look back at those moments when they were missing those two front teeth, and when they loved to wear cat earrings. During sibling & portrait (birthday) sessions, those sweet features will be forever documented.
