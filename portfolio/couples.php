  ...
  <head>
    ...
    <style>
      ...
      .col-md-4 {
        ...
        background-image: url("../images/covers/IMG_0119.jpg");
  ...
  <body>
        ...
        <?php
            ...
            foreach($files as $file) {
                ...
                if($file !== "." && $file !== "..") {
                    ...
                    echo "<img src='../images/couples/$file' />";
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <h1>Couples Photo Sessions</h1>

        <br />

        <h3>

          Dear couples,<br /><br />You do not have to be engaged, you do not have to

          be pregnant, it does not have to be your anniversary to get your

          photos done! Those are just a few milestones in your life, don’t get

          me wrong, those are very very important moments that should 100% be

          captured BUT, what about the day to day life? Do you have a photo that

          represents that love? I would be honoured to capture your ‘Just

          Because’ couple session too.
