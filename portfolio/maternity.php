  ...
  <head>
    ...
    <style>
      ...
      .col-md-4 {
        ...
        background-image: url("../images/covers/IMG_7097.jpg");
  ...
  <body>
    ...
    <div class="gallery">
      ...
      >
        ...
        <?php
            ...
            $files = scandir('../images/maternity');
            ...
            foreach($files as $file) {
                ...
                if($file !== "." && $file !== "..") {
                    ...
                    echo "<img src='../images/maternity/$file' />";
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <h1>Maternity Photo Sessions</h1>

        <br />

        <h3>

          Nine months. That may seem like forever but may also go by in the

          blink of an eye; which is why capturing this precious moment is even

          more important. To think that in a few years this baby will be looking

          back at these photos and won’t even believe that they fit in Mommy’s

          tummy. The anticipation of a baby is such a unique and special

          experience that I would be honoured to photograph so you can have this
