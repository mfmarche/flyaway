  ...
  <head>
    ...
    <style>
      ...
      .col-md-4 {
        ...
        background-image: url("../images/covers/IMG_2754.jpg");
  ...
  <body>
        ...
        <?php
            ...
            foreach($files as $file) {
                ...
                if($file !== "." && $file !== "..") {
                    ...
                    echo "<img src='../images/family/$file' />";
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <h1>Family Photo Sessions</h1>

        <br />

        <h3>

          Fun. Love. Connection. These are just some of the words that come to

          mind when I think about Family Sessions. We will definitely capture

          that posed photo of everyone smiling at the camera that grandparents

          love to have. The rest of the session will be me capturing your family

          in a candid way. We will play games, there may be some tickle fights,

          some skipping and holding hands. I will capture your family together,

          I will also photograph sibling photos, portraits of each kid, each

          parent and kids, couple shots, and 1:1 parent and kiddo. I would be

          honored to document this moment in time for you.
